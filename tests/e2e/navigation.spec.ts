...
test.describe('Navigation', () => {
  test.describe('Page Navigation', () => {
    test('should navigate from Home to Projects page', async ({ page }) => {
      ...
      // Check for the visible heading (not sr-only)
      await expect(page.getByRole('heading', { name: 'All Projects' }).nth(1)).toBeVisible();
    });
    ...
    test('should navigate using logo link', async ({ page }) => {
      ...
      await page.getByRole('link', { name: /Liam West/i }).first().click();
